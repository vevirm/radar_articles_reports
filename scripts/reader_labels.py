...
OBJECT_LABELS: dict[str, str] = {
    ...
    "talent.retention": "research careers in Europe",
...
CLUSTER_STAKES: dict[str, str] = {
    "compute_ai": "whether European researchers and firms have enough computing power of their own",
    "permitting_siting": "where in Europe data centres can be built, and how fast",
    "quantum": "whether European quantum research leads to machines that Europe controls",
    "chips": "whether Europe can get the chips that everything else needs",
    "startups_chips_industry": "whether European chip start-ups can grow in Europe",
    "export_controls": "who decides what technology Europe may share or receive",
    "eu_competence": "whether the EU can act as one",
    "openness": "how open European science can stay",
    "research_security": "who European labs may work with, and on what",
    "talent": "who does research in Europe, and whether they stay",
    "funding_programme": "what Europe can afford to research, and with whom",
    "programme_association": "which countries can do research with Europe on equal terms",
    ...
    "capital_markets": "whether European technology firms can grow without being sold abroad",
    "strategic_goals": "whether Europe can act without asking others for permission",
    "health": "whether Europe can research and produce its own health technology",
    "research_system": "how much European research produces, and how well it copes with shocks",
    "research_infrastructure": "which researchers can use Europe's large research facilities",
    "ai_governance": "who writes the rules for AI used in Europe",
    "digital_governance": "who controls Europe's data and digital services",
    "defence_dual_use": "how fast new defence technology reaches use",
    "innovation_ecosystem": "whether research done in Europe becomes companies and jobs in Europe",
    "industrial_competitiveness": "whether Europe still makes the things it invents",
    "cybersecurity": "whether European systems keep working under attack",
    "green_transition": "how fast, and at what cost, Europe switches to clean technology",
