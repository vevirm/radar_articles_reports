...
class V15ScanRepairTests(unittest.TestCase):
    ...
    def test_packaged_scanner_budget_fits_active_30_minute_workflow(self):
        self.assertLessEqual(int(sr.CONFIG["scan_budget_seconds"]), 1200)
        self.assertGreaterEqual(int(sr.CONFIG["scan_budget_seconds"]), 900)
