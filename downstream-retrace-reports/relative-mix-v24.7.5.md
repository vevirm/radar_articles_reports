...
Completed: `2026-09-12T09:28:27Z`
Tool version: `v1.0-current-downstream-rules`
Source revalidation report: `revalidation-reports/full-corpus-revalidation-20260911T005837Z.json`

## Final diagnostics

- Derived objects checked: **47**
- Unchanged: **23**
- Rebuilt: **24**
- Materially rewritten: **0**
- Newly inferred: **0**
- Retired: **0**
- Stale evidence-reference occurrences removed: **72**
- Orphan references remaining: **0**
- Shock support chains changed because an A-item disappeared: **0**
...
- Dynamic shocks: **16**
- High-order candidates: **24**
- Strategic pathways: **3**
- Possible external shocks: **0**
- Standalone stored matrix registry objects: **0**
